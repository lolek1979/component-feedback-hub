...
import Checkbox, { Default, Checked, Disabled, DisabledChecked, Error, CheckedMultiselect} from './Checkbox.stories';

<Meta of={Checkbox} />

#### Design: <a href="https://www.figma.com/design/HtK3DbPIxodKas2jSTtrlH/Design-system?node-id=1-10" target="_blank" rel="noopener">Figma</a>
